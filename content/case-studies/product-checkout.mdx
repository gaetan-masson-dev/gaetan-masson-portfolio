...
contribution: Designed streamlined booking and checkout flow
scope: End-to-end transactional experience
context: Multiple products (accommodation + activities)
impact: Reduced friction and simplified user journey
...
<Figure src="/images/product-checkout/Checkout-flow-1.jpg" alt="" caption="Our simple user flow" />
