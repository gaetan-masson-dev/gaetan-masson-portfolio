...
contribution: Redesigned multi-vertical search experience
scope: Search UX & information architecture
context: Complex data structure, mismatched mental models
impact: Improved usability and relevance of search results
