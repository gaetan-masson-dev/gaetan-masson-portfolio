...
contribution: Defined scalable settings architecture across product
scope: Information architecture redesign (50+ views)
context: 13 teams, no structure, growing complexity
impact: Enabled long-term scalability and navigation redesign
